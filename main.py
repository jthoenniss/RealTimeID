...
if __name__ == "__main__":
    ...
    filename = f"data/delta_t=0.1_rel_error=0.01_large.h5"
    ...
    print(f"Starting computation of data on parameter grid with dimensions [h: {param_grid_dims[0]}, N_max: {param_grid_dims[1]}, beta: {param_grid_dims[2]}].")
